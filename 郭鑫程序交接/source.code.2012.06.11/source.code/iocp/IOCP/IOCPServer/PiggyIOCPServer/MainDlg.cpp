...
{
	CDialog::DoDataExchange(pDX);
	DDX_Control(pDX, IDC_STATIC_RECV_NUM, recv_num_static_);
}
...
UINT_PTR __timer = NULL;

///////////////////////////////////////////////////////////////////////
//	开始监听
void CMainDlg::OnBnClickedOk()
{
	__timer = SetTimer(1, 1000, NULL);
...
void CMainDlg::OnTimer(UINT ID)
{
	char buf[260] = {0};
	if(ID == 1){
		sprintf(buf, "%d", InterlockedCompareExchange(&m_IOCP.recv_num_, 0, 0));
		recv_num_static_.SetWindowText(buf);
	}
}
