...
IMPLEMENT_DYNAMIC(CLeftViewBarInstrumentBottom, CMyBCGPDockingControlBar)
...
BEGIN_MESSAGE_MAP(CLeftViewBarInstrumentBottom, CMyBCGPDockingControlBar)
...
{
	CMyBCGPDockingControlBar::OnSize(nType, cx, cy);
	if (CanAdjustLayout())
	{
		CRect rc;
		GetClientRect(rc);
...
{
	CMyBCGPDockingControlBar::OnSetFocus(pOldWnd);
}
