...
CSpreadGenericList::CSpreadGenericList(void)
{
}
...
* @return void
*/
void CSpreadGenericList::OnInit()
{
	m_uiCountAll = 0;	// 总数	
	ParseXML();	// 解析配置文件
}
...
* @return void
*/
void CSpreadGenericList::OnReload(void)
{
	m_uiCountAll = 0;	// 总数
	m_olsSpreadGeneric.RemoveAll();	// 移除队列
	ParseXML();	// 解析配置文件
}
...
* @return void
*/
void CSpreadGenericList::OnClose()
{
	m_uiCountAll = 0;	// 总数
	m_olsSpreadGeneric.RemoveAll();	// 移除队列
}
...
* @return void
*/
void CSpreadGenericList::ParseXML()
{
	CString strKey;
	...
	for(i = 0; i < m_uiCountAll; i++)
	{
		...
		// 增加
		m_olsSpreadGeneric.AddTail(oSpread);
	}
}
...
* @return void
*/
void CSpreadGenericList::OnSave()
{
	CString strKey;
	...
	{
		oSpread = m_olsSpreadGeneric.RemoveHead();
