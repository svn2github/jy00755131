...
#define InstrumentDistortionTestType	(0x00000001 << 1)
#define InstrumentCrosstalkTestType		(0x00000001 << 2)
#define InstrumentCMRRTestType			(0x00000001 << 3)
#define InstrumentGainPhaseTestType		(0x00000001 << 4)
#define SensorResistanceTestType		(0x00000001 << 5)
#define SensorLeakageTestType			(0x00000001 << 6)
#define SensorNoiseTestType				(0x00000001 << 7)
#define SensorTiltTestType				(0x00000001 << 8)
#define SensorTiltModelTestType			(0x00000001 << 9)
#define SeisMonitorTestType				(0x00000001 << 10)
// 网络传输的ADC数据位数
#define ADCDataBytes					3
// 仪器表网格大小，仪器SN为0则表示无仪器
// 仪器结构体大小为8 Bytes
#define InstrumentTableWindowSize		170
// 数据表网格大小
// 数据大小为3 Bytes
#define DataTableWindowSize				454
// /** 仪器状态位判断是否跳过道*/
// #define InstrumentStatusJumpedChannel	0x00000001
// /** 仪器状态位判断是否连接检波器*/
// #define InstrumentStatusSensor			(0x00000001 << 1)
// /** 仪器状态位判断是否辅助道*/
// #define InstrumentStatusAux				(0x00000001 << 2)
// /** 仪器状态位判断是否连接爆炸机*/
// #define InstrumentStatusBlastMachine	(0x00000001 << 3)
// /** 仪器状态位判断是否迂回道*/
// #define InstrumentStatusDetour			(0x00000001 << 4)
// /** 仪器状态位判断是否迂回道低端标记点*/
// #define InstrumentStatusDetourMarkerLow	(0x00000001 << 5)
// /** 仪器状态位判断是否迂回道高端标记点*/
// #define InstrumentStatusDetourMarkerHigh	(0x00000001 << 6)
// /** 仪器状态位判断是否迂回道停止标记*/
// #define InstrumentStatusStopMarking		(0x00000001 << 7)
// /** 仪器状态位判断是否标记点*/
// #define InstrumentStatusMarker			(0x00000001 << 8)
// /** 仪器状态位判断是否哑道*/
// #define InstrumentStatusMute			(0x00000001 << 9)
// /** 仪器状态位判断IP地址设置是否成功*/
// #define InstrumentStatusIPSetOK			(0x00000001 << 10)
// /** 仪器状态位判断仪器时间设置是否成功*/
// #define InstrumentStatusTimeSetOK		(0x00000001 << 11)
// /** 仪器状态位判断仪器是否进行了ADC参数设置*/
// #define InstrumentStatusADCSet			(0x00000001 << 12)
...
// 全网仪器列表更新
#define CmdWholeTable				0x000c
// 当前仪器列表更新
#define CmdUpdateTable				0x000d
// 查询某个区域客户端只需发送行号和区域号
// 服务端则在区域号和行号后再加入仪器或数值
// 查询仪器列表某个区域（后跟局域序号，1个字节的行号和1个字节的区域序号）
#define CmdQueryAreaTable			0x000e
// 查询某个区域仪器在同一时刻的采样值
#define CmdQueryAreaData			0x000f
//心跳操作
#define CmdHitTest					0x0010
