...
*@brief 检波器视图左侧子视图上部类
*/
class CLeftViewBarSensorTop : public CBCGPDockingControlBar
{
	DECLARE_DYNAMIC(CLeftViewBarSensorTop)

public:
	CLeftViewBarSensorTop();
	virtual ~CLeftViewBarSensorTop();

protected:
	//{{AFX_MSG(CLeftViewBarSensorTop)
