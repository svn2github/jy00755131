...
void CStartView::SetBitmap ()
{
	...
	BOOL bIsVS2010Look = CBCGPVisualManager::GetInstance()->IsKindOf(RUNTIME_CLASS(CBCGPVisualManagerVS2010));

	m_Image.SetImage (bIsVS2010Look ? IDB_START_HC_2010 : IDB_START_HC);
	m_Image.SetBackgroundColor (bIsVS2010Look ? RGB (79, 105, 148) : RGB (227, 232, 242));
