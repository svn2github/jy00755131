...
* @return void
*/
void CTestElementData::CalculateTestResult(unsigned int uiTestType, byte* pData, unsigned int uiSamplingPointCount,int m_AVGNoiseValue)
{
	int uiData = 0;
	...
	case 4:
		...
		m_fInstrumentNoiseValue = (float)uiData;
		break;
		// 	仪器测试，仪器畸变
	case 5:
		if(0x7fffff == uiData)
