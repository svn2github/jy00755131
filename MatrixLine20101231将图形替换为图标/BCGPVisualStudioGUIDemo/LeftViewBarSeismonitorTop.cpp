...
IMPLEMENT_DYNAMIC(CLeftViewBarSeismonitorTop, CBCGPDockingControlBar)

CLeftViewBarSeismonitorTop::CLeftViewBarSeismonitorTop()
{
...
BEGIN_MESSAGE_MAP(CLeftViewBarSeismonitorTop, CBCGPDockingControlBar)
	//{{AFX_MSG_MAP(CLeftViewBarSeismonitorTop)
	ON_WM_CREATE()
	ON_WM_SIZE()
	ON_WM_PAINT()
	//}}AFX_MSG_MAP
...
/////////////////////////////////////////////////////////////////////////////
// CLeftViewBarSeismonitorTop message handlers

int CLeftViewBarSeismonitorTop::OnCreate(LPCREATESTRUCT lpCreateStruct) 
{
...
void CLeftViewBarSeismonitorTop::OnSize(UINT nType, int cx, int cy) 
{
...
void CLeftViewBarSeismonitorTop::OnPaint() 
{
	CPaintDC dc(this);
	GetClientRect(&m_oRect);
...
void CLeftViewBarSeismonitorTop::OnLButtonDown(UINT nFlags, CPoint point)
{
	// 判断：可以画图
	if(true == m_bCanDrawGraph)
	{
...
void CLeftViewBarSeismonitorTop::OnLButtonUp(UINT nFlags, CPoint point)
{
	// 判断：鼠标左键是否按下 && 可以画图
...
void CLeftViewBarSeismonitorTop::OnMouseMove(UINT nFlags, CPoint point)
{
	// 判断：鼠标左键是否按下 && 可以画图
	if((true == m_bMouseDownLeft) && (true == m_bCanDrawGraph))
	{
...
* @return void
*/
void CLeftViewBarSeismonitorTop::OnZoomInNavigater()
{
...
* @return void
*/
void CLeftViewBarSeismonitorTop::OnSetLineCount(unsigned int uiLineCount)
{
	m_bDrawSelectArea = false;	// 是否画鼠标选中区域位置
...
*/
bool CLeftViewBarSeismonitorTop::GetSelectAreaPoint()
{
...
* @return void
*/
void CLeftViewBarSeismonitorTop::DrawBackground(CDC* pDC)
{
	CBrush oBrush;
	CBrush* pOldPenBrush;
...
*/
bool CLeftViewBarSeismonitorTop::CheckIfCanDraw()
{
	if(0 == m_uiLineCount)
	{
...
* @return void
*/
void CLeftViewBarSeismonitorTop::DrawLines(CDC* pDC)
{
	CPen oPenLine;
	CPen* pOldPen;
...
* @return void
*/
void CLeftViewBarSeismonitorTop::DrawSelectArea(CDC* pDC)
{
