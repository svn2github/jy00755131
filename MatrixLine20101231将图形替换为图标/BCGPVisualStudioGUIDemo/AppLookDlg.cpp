...
void CAppLookDlg::SetLook ()
{
	...
	if (pMainFrame != NULL)
	{
		pMainFrame->OnChangeLook (
					...
					m_nAppLook == 4 || m_nAppLook == 2 || m_nAppLook == 3 || m_nAppLook == 5 || m_nAppLook == 6 || m_nAppLook == 7 || m_nAppLook == 8	/* Extended toolbox */,
					m_bActiveTabCloseButton,
					m_nAppLook == 3 || m_nAppLook == 6 || m_nAppLook == 7 || m_nAppLook == 8);
