...
protected:
	...
	afx_msg void OnMatrixFieldOn();	// 
	afx_msg void OnMatrixFieldOff();	// 
	afx_msg void OnToolbarMatrixViewGraph();	// 
	afx_msg void OnToolbarMatrixViewList();	// 
	//}}AFX_MSG
...
public: // 属性
	CSiteData m_oSiteData;	// 现场数据对象
	CDlgSurveySetup* m_pDlgSurveySetup;	// 地形设置
	CDlgLayoutSetup* m_pDlgLayoutSetup;	// 布局设置
	CDlgSpreadSetup* m_pDlgSpreadSetup;	// 排列设置
	CDlgTestBaseSetup* m_pDlgTestBaseSetup;	// 测试基本设置
	CDlgTestSetup* m_pDlgTestSetup;	// 测试设置
	CDlgLookSetup* m_pDlgLookSetup;	// Look设置
	CDlgFormLineSetup* m_pDlgFormLineSetup;	// FormLine设置
