...
public:
	...
	CMultiDocTemplate*		m_pDocTemplateInstrumentList;	// 仪器列表文档模板
	CMultiDocTemplate*		m_pDocTemplateSensorList;	// 检波器列表文档模板

	CMultiDocTemplate*		m_pDocTemplateInstrumentGraph;	// 仪器图形文档模板
	CMultiDocTemplate*		m_pDocTemplateSensorGraph;	// 检波器图形文档模板
	CMultiDocTemplate*		m_pDocTemplateSeismonitorGraph;	// 噪声监测图形文档模板
