...
*@brief 仪器视图左侧子视图上部类
*/
class CLeftViewBarInstrumentTop : public CBCGPDockingControlBar
{
	DECLARE_DYNAMIC(CLeftViewBarInstrumentTop)

public:
	CLeftViewBarInstrumentTop();
	virtual ~CLeftViewBarInstrumentTop();

protected:
	//{{AFX_MSG(CLeftViewBarInstrumentTop)
