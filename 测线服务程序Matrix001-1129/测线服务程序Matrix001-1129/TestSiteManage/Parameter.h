...
// ADC参数设置应答接收缓冲区大小
#define ADCSetReturnBufSize		0x100000
...
// ADC零漂校正过程连续采集延时
#define ADCReadContinuousSleepTime			600
// ADC参数设置应答延时
#define ADCSetReturnSleepTime						50
// 端口监视发送线程Sleep时间
...
// 发送设置命令
#define ViewStartCmd							0x0003
// 发送查询命令
#define ViewStopCmd								0x0004
// 发送ADC采样数据重发命令
...
#define TabSampleADCSetReturnTimerSet			2000
