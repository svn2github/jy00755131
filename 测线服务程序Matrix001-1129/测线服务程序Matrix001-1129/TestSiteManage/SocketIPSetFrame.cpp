...
void CSocketIPSetFrame::MakeFrameData(CInstrument* pInstrument)
{
	...
	TRACE3("IP设置1-IP=%x m_uiInstrumentType=%x m_uiRoutDirection=%x\r\n",m_oFrameIPSet.m_uiSN,m_oFrameIPSet.m_uiInstrumentType,pInstrument->m_uiRoutDirection);
	TRACE3("IP设置2-IP=%x m_uiRoutIPTop=%x m_uiRoutIPDown=%x\r\n", pInstrument->m_uiIP,m_oFrameIPSet.m_uiRoutIPTop,m_oFrameIPSet.m_uiRoutIPDown);
	// 生成帧
