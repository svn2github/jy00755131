...
// 端口监视端口缓冲区大小，48个站4K采样率每秒约需650K缓冲，设为1000K
#define PortMonitoringBufSize	1024000
// 串口转UDP端口缓冲区大小，串口波特率为115200，即每秒14400Byte
#define UartToUDPBufSize	14400
// ADC数据重发端口缓冲区大小，48个站，每个站每秒需重发20帧
#define ADCRetransmissionBufSize	245760
// ADC数据端口接收缓冲区大小，48个站4K采样率每秒约需650K缓冲，设为1000K
#define ADCBufSize	1024000
// UDP通讯ADC采样接收缓冲区大小,考虑到连包的情况，设缓冲区为16帧大小
