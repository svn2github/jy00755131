...
BOOL CDlgShotPoint::OnInitDialog()
{
	...
	m_wndListGrid.InsertColumn (0, _T("Shot Id"), 36);
	m_wndListGrid.InsertColumn (1, _T("BreakPoint"), 36);
	m_wndListGrid.InsertColumn (2, _T("Swath Nb"), 40);
	m_wndListGrid.InsertColumn (3, _T("Source Line"), 41);
	m_wndListGrid.InsertColumn (4, _T("Source Rcv"), 45);

	m_wndListGrid.InsertColumn (5, _T("Spread Sfl"), 41);
	m_wndListGrid.InsertColumn (6, _T("Spread Sfn"), 41);
	m_wndListGrid.InsertColumn (7, _T("Spread Type"), 40);
	m_wndListGrid.InsertColumn (8, _T("Super Spread"), 48);
	m_wndListGrid.InsertColumn (9, _T("Proc Type"), 40);
	m_wndListGrid.InsertColumn (10, _T("Comment"), 63);
	...
	m_wndEditGrid.InsertColumn (0, _T("Shot Id"), 36);
	m_wndEditGrid.InsertColumn (1, _T("BreakPoint"), 36);
	m_wndEditGrid.InsertColumn (2, _T("Swath Nb"), 40);
	m_wndEditGrid.InsertColumn (3, _T("Source Line"), 41);
	m_wndEditGrid.InsertColumn (4, _T("Source Rcv"), 45);

	m_wndEditGrid.InsertColumn (5, _T("Spread Sfl"), 41);
	m_wndEditGrid.InsertColumn (6, _T("Spread Sfn"), 41);
	m_wndEditGrid.InsertColumn (7, _T("Spread Type"), 40);
	m_wndEditGrid.InsertColumn (8, _T("Super Spread"), 48);
	m_wndEditGrid.InsertColumn (9, _T("Proc Type"), 40);
	m_wndEditGrid.InsertColumn (10, _T("Comment"), 63);
