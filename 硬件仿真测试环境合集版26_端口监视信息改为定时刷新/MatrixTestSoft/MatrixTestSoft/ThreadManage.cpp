...
void CThreadManage::MakeCollectSysTimeFrameData(int* pSelectObject)
{
	...
	{
		m_cCollectSysTimeSendData[i] = SndFrameBufSet;
	}
	m_cCollectSysTimeSendData[0] = FrameHead0;
	m_cCollectSysTimeSendData[1] = FrameHead1;
	m_cCollectSysTimeSendData[2] = FrameHead2;
	m_cCollectSysTimeSendData[3] = FrameHead3;
