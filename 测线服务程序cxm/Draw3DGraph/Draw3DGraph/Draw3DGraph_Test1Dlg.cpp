...
#include "stdafx.h"
#include "Draw3DGraph_Test1.h"
#include "Draw3DGraph_Test1Dlg.h"
...
CDraw3DGraph_Test1Dlg::CDraw3DGraph_Test1Dlg(CWnd* pParent /*=NULL*/)
	: CDialog(CDraw3DGraph_Test1Dlg::IDD, pParent)
	, m_iCounter(0)
{
	m_hIcon = AfxGetApp()->LoadIcon(IDR_MAINFRAME);
}

void CDraw3DGraph_Test1Dlg::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
...
BEGIN_MESSAGE_MAP(CDraw3DGraph_Test1Dlg, CDialog)
	ON_WM_SYSCOMMAND()
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	//}}AFX_MSG_MAP
	ON_BN_CLICKED(IDC_BTN_START, &CDraw3DGraph_Test1Dlg::OnBnClickedBtnStart)
	ON_BN_CLICKED(IDC_BTN_STOP, &CDraw3DGraph_Test1Dlg::OnBnClickedBtnStop)
	ON_BN_CLICKED(IDC_RADIO_SURFACE, &CDraw3DGraph_Test1Dlg::OnBnClickedRadioSurface)
	ON_BN_CLICKED(IDC_RADIO_SURFACELINE, &CDraw3DGraph_Test1Dlg::OnBnClickedRadioSurfaceline)
	ON_WM_TIMER()
END_MESSAGE_MAP()
...
BOOL CDraw3DGraph_Test1Dlg::OnInitDialog()
{
...
void CDraw3DGraph_Test1Dlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
void CDraw3DGraph_Test1Dlg::OnPaint()
{
	if (IsIconic())
	{
...
//显示。
HCURSOR CDraw3DGraph_Test1Dlg::OnQueryDragIcon()
{
	return static_cast<HCURSOR>(m_hIcon);
}


void CDraw3DGraph_Test1Dlg::OnBnClickedBtnStart()
{
	// TODO: 在此添加控件通知处理程序代码
	SetTimer(TimerID, TimerDelay, NULL);
}

void CDraw3DGraph_Test1Dlg::OnBnClickedBtnStop()
{
	// TODO: 在此添加控件通知处理程序代码
	KillTimer(TimerID);
}

void CDraw3DGraph_Test1Dlg::OnBnClickedRadioSurface()
{
	// TODO: 在此添加控件通知处理程序代码
	m_ctrlGraph3D.GetPlots().Item(1).SetStyle(CNiPlot3D::Surface);
}

void CDraw3DGraph_Test1Dlg::OnBnClickedRadioSurfaceline()
{
	// TODO: 在此添加控件通知处理程序代码
	m_ctrlGraph3D.GetPlots().Item(1).SetStyle(CNiPlot3D::SurfaceLine);
}

void CDraw3DGraph_Test1Dlg::OnTimer(UINT_PTR nIDEvent)
{
