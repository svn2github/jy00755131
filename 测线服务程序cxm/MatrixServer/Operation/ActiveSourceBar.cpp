...
bool CActiveSourceBar::SetGridHead(void)
{
	...
	m_GridView.SetHeaderAlign (12, HDF_CENTER);
	m_GridView.SetColumnAlign (12, HDF_RIGHT);
	m_GridView.InsertColumn (13, _T("Spread#"), 80);
	m_GridView.SetHeaderAlign (13, HDF_CENTER);
	m_GridView.SetColumnAlign (13, HDF_RIGHT);
	m_GridView.InsertColumn (14, _T("SuperSpread"), 100);
	m_GridView.SetHeaderAlign (14, HDF_CENTER);
	m_GridView.SetColumnAlign (14, HDF_RIGHT);
	m_GridView.InsertColumn (15, _T("ProcessType"), 100);
	m_GridView.SetHeaderAlign (15, HDF_CENTER);
	m_GridView.SetColumnAlign (15, HDF_RIGHT);
	m_GridView.InsertColumn (16, _T("Swath"), 60);
	m_GridView.SetHeaderAlign (16, HDF_CENTER);
	m_GridView.SetColumnAlign (16, HDF_RIGHT);
	return true;
}
