...
BOOL CMatrixServerDlg::OnInitDialog()
{
	...
	m_oComDll.m_oCommServerDll.m_pLineSetupData = m_oMatrixDllCall.m_pEnv->m_pInstrumentCommInfo->m_pLineSetupData;
	m_oComDll.m_oCommServerDll.m_pOptSetupData = m_oMatrixDllCall.m_pEnv->m_pInstrumentCommInfo->m_pOptSetupData;
