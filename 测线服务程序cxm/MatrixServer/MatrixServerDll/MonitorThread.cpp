		...
		iter != pMonitorThread->m_pRoutList->m_oRoutMap.end(); iter++)
	{
			...
			&& (iter->second->m_pTail != NULL))
		{
			...
			else
			{
				...
				TRACE(_T("MonitorRout1_3\n"));
			}
		}
	}
	TRACE(_T("MonitorRout2\n"));
	// 删除路由删除索引表中的仪器
	while(1)
	{
