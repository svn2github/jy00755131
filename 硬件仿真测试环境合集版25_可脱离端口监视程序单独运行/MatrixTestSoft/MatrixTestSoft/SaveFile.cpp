...
void CSaveFile::OnSaveToFile(void)
{
	...
	str.Format("\\%04d%02d%02d%02d%02d%02d%04d.text",sysTime.wYear,sysTime.wMonth,sysTime.wDay,
	...
	if (csSaveReceiveFileTemp.GetLength() != 0)
	{
		strFileName = "";
		strFileName += m_csSaveFilePath;
		str.Format("\\Rec%04d%02d%02d%02d%02d%02d%04d.text",sysTime.wYear,sysTime.wMonth,sysTime.wDay,
			sysTime.wHour,sysTime.wMinute,sysTime.wSecond,sysTime.wMilliseconds);
		strFileName += str;
		m_file = NULL;
		//保存成ANSI格式的文件
	...
	if (csSaveSendFileTemp.GetLength() != 0)
	{
		strFileName = "";
		strFileName += m_csSaveFilePath;
		str.Format("\\Send%04d%02d%02d%02d%02d%02d%04d.text",sysTime.wYear,sysTime.wMonth,sysTime.wDay,
			sysTime.wHour,sysTime.wMinute,sysTime.wSecond,sysTime.wMilliseconds);
		strFileName += str;
		m_file = NULL;
		//保存成ANSI格式的文件
