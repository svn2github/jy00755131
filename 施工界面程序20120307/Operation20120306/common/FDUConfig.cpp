...
, m_dwLineDataRateIndex(0)
, m_dwTimeManageIndex(0)
, m_dwGPSConnIndex(0)
, m_dwSourceConnIndex(0)
, m_dwHighpassFrequencyIndex(0)
, m_strCrewName(_T(""))
{
	InitFUDConfig();
}
...
/*	m_dwSampleRates[0]=250;		// 4k
	...
	m_dwSampleRates[0] = 250;
	m_dwSampleRates[1] = 500;
	m_dwSampleRates[2] = 1000;
	m_dwSampleRates[3] = 2000;
	m_dwSampleRates[4] = 4000;
	...
	high_pass_frequency[0] = 0.5;
	high_pass_frequency[1] = 1.0;
