...
int CMainFrame::OnCreate(LPCREATESTRUCT lpCreateStruct)
{
	...
	if (!m_wndWorkSpace.Create (_T("View  1"), this, CRect (0, 0, 1024, 200),
	...
	if (!m_wndWorkSpace2.Create (_T("View 2"), this, CRect (0, 201, 1024, 400),
	...
	if (!m_wndWorkSpace3.Create (_T("View 3"), this, CRect (0, 401, 1024, 600),
		TRUE, ID_VIEW_USER_TOOLBAR1,
		WS_CHILD | WS_VISIBLE | WS_CLIPSIBLINGS | WS_CLIPCHILDREN | CBRS_TOP | CBRS_FLOAT_MULTI))
	{
		TRACE0("Failed to create Workspace bar 2\n");
		return -1;      // fail to create
	...
	if (!m_wndOutput.Create (_T("Output"), this, CRect (0, 601, 1024, 800),
