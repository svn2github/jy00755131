...
public: // 属性
	...
	/** 野外电阻测试结果0：未测试；：测试合格；：测试不合格；：无信号；：未判读*/
	...
	/** 野外漏电测试结果0：未测试；：测试合格；：测试不合格；：无信号；：未判读*/
	...
	/** 野外噪声测试值*/
	float m_fNoiseValue;
	/** 野外噪声测试结果0：未测试；：测试合格；：测试不合格；：无信号；：未判读*/
	byte m_byNoiseCheck;
	/** 野外噪声测试判据*/
	float m_fNoiseLimit;
	...
	/** 野外倾斜度测试值*/
	float m_fTiltValue;
	/** 野外倾斜度测试结果0：未测试；：测试合格；：测试不合格；：无信号；：未判读*/
	byte m_byTiltCheck;
	/** 野外倾斜度测试判据*/
	float m_fTiltLimit;
	...
	/** 野外倾斜度模型测试结果0：未测试；：测试合格；：测试不合格；：无信号；：未判读*/
	byte m_byTiltModelCheck;
	/** 野外倾斜度模型测试判据*/
	float m_fTiltModelLimit;

	/** 野外测试结果0：未测试；：测试合格；：测试不合格；：无信号；：未判读*/
	byte m_byCheck;

	/** 噪声监测测试值*/
	float m_fNoiseMonitorValue;
	/** 噪声监测测试结果0：未测试；：测试合格；：测试不合格；：无信号；：未判读*/
	byte m_byNoiseMonitorCheck;

	/** 检波器是否进行了初始测试*/
	byte m_byTestOnField;
	/** 初始测试结果0：未测试；：测试合格；：测试不合格；：无信号；：未判读*/
