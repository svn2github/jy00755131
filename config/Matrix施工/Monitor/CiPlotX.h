...
class CiPlotX : public COleDispatchDriver
{
public:
	CiPlotX(){} // 调用 COleDispatchDriver 默认构造函数
	CiPlotX(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CiPlotX(const CiPlotX& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
