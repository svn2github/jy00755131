...
class CiPlotX0 : public COleDispatchDriver
{
public:
	CiPlotX0(){} // 调用 COleDispatchDriver 默认构造函数
	CiPlotX0(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CiPlotX0(const CiPlotX0& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
