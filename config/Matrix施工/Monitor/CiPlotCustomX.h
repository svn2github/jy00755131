...
class CiPlotCustomX : public COleDispatchDriver
{
public:
	CiPlotCustomX(){} // 调用 COleDispatchDriver 默认构造函数
	CiPlotCustomX(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CiPlotCustomX(const CiPlotCustomX& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
