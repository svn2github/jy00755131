...
class CiPlotXEvents : public COleDispatchDriver
{
public:
	CiPlotXEvents(){} // 调用 COleDispatchDriver 默认构造函数
	CiPlotXEvents(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	CiPlotXEvents(const CiPlotXEvents& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
